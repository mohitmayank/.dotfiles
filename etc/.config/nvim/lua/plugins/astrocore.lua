-- astrocore.lua — user keymaps and options
  ...
  opts = {
    ...
    mappings = {
      ...
      n = {
        ...
        -- <C-p> — file search (like CtrlP in vim)
        ["<C-p>"] = { function() Snacks.picker.files() end, desc = "Find files" },

        -- <C-o> — buffer search (like CtrlPBuffer in vim)
        ["<C-o>"] = { function() Snacks.picker.buffers() end, desc = "Find buffers" },

        -- <C-n> — toggle file tree (like NERDTree in vim)
